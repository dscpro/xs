...
<link rel="stylesheet" type="text/css" href="css/login_css.css">
  ...
  <body>
	...
	<div style="padding-left: 100px;padding-top:50px;">
	  <img id="logoimg" src="img/logo.png" style="width: 330px;height: 54px;"/>	
	</div>
	<div id="menu">
		<ul>
			<li>
	...
	right:220px;top:150px;position:absolute;">
	<div style="padding:5px;">
	<p style="padding-top:5px;padding-left:5px;"><b>登录<b/></p>
    <form method="post" action="customer_login.action" OnSubmit="return check();" name="myform">
